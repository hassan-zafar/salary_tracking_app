  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        (shouldShowDays!) ? _buildSpace() : const SizedBox(),
      ...
      rows.add(
        Container(
          ...
          child: Digit<int>(
            ...
            itemStream: timeStream.map<int>((event) => digits[i] as int),
        ...
        Row(
          ...
          children: [
            Container(
              ...
              child: Digit<int>(
                padding: widget.padding!,
                itemStream: timeStream.map<int>((event) => tensDigit as int),
            ...
            Container(
              ...
              child: Digit<int>(
                padding: widget.padding!,
                itemStream: timeStream.map<int>((event) => onesDigit as int),
